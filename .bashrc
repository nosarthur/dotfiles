...
alias caa='conda activate ama-dev'
alias cam='conda activate atommap-dev'
alias cad='conda deactivate'
alias cap='conda activate parmedizer-dev'
alias caq='conda activate amqm-dev'
alias cas='conda activate siflow-dev'
...
alias h='head'
alias i=vifm
alias ic='imgcat -H 60%'
alias icc='imgcat -H 90%'
alias ict='imgcat -H 50% `ls -tp| rg -v / | fzf`'
